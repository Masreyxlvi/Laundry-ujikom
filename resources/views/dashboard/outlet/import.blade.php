<div class="modal fade" id="importOutlet" tabindex="-1" aria-labelledby="importOutlet-label" aria-hidden="true">
		 ...
		 <form action="/outlet/import" method="POST" enctype="multipart/form-data"
			  ...
			  <div class="modal-content">
					<div class="modal-header">
						 <h5 class="modal-title" id="importOutlet-label">Import Data Outlet</h5>
					...
					<div class="modal-body">
						 ...
						 <div class="text-center py-5" id="select-import-file">
							  ...
							  <div>Klik <a href="outlet/download">disini</a> untuk
									mengunduh
									template</div>
						 </div>
