<div class="modal fade" id="importbarang" tabindex="-1" aria-labelledby="importbarang-label" aria-hidden="true">
		 ...
		 <form action="/barang/import" method="POST" enctype="multipart/form-data"
			  ...
			  <div class="modal-content">
					<div class="modal-header">
						 <h5 class="modal-title" id="importbarang-label">Import Data barang</h5>
					...
					<div class="modal-body">
						 ...
						 <div class="text-center py-5" id="select-import-file">
							  ...
							  <div>Klik <a href="barang/download">disini</a> untuk
									mengunduh
									template</div>
						 </div>
