<div class="modal fade" id="importPaket" tabindex="-1" aria-labelledby="importPaket-label" aria-hidden="true">
	<div class="modal-dialog">
		 <form action="/paket/import" method="POST" enctype="multipart/form-data"
			  id="import-form">
			  @csrf
			  <div class="modal-content">
					<div class="modal-header">
						 <h5 class="modal-title" id="importPaket-label">Import Data Paket</h5>
					...
					<div class="modal-body">
						 ...
						 <div class="text-center py-5" id="select-import-file">
							  ...
							  <div>Klik <a href="paket/download">disini</a> untuk
									mengunduh
									template</div>
						 </div>
