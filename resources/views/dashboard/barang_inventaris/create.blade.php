  <!-- Modal -->
  <div class="modal fade" id="Barang_inventaris" tabindex="-1" aria-labelledby="Barang_inventarisLabel" aria-hidden="true">
	<div class="modal-dialog">
	  <div class="modal-content">
		<div class="modal-header">
		  <h5 class="modal-title" id="Barang_inventarisLabel">Modal Barang</h5>
		  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		</div>
		<div class="modal-body">
			<form action="/barang_inventaris" method="post">
				@csrf
				<div class="mb-3">
